...
function usage() {
       echo "Usage: $0 <android10|buildroot|friendlycore-focal-arm64|friendlycore-lite-focal-kernel4-arm64|friendlywrt-kernel4>"
       echo "# example:"
...
case ${TARGET_OS} in
buildroot*|android10|friendlycore-lite-focal-kernel4-arm64|friendlycore-focal-arm64|friendlywrt* )
        ;;
*)
