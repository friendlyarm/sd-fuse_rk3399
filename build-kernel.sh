...
function usage() {
       echo "Usage: $0 <android10|buildroot|friendlycore-focal-arm64|debian-buster-desktop-arm64|friendlycore-lite-focal-kernel4-arm64|friendlywrt-kernel4>"
       echo "# example:"
...
case ${TARGET_OS} in
buildroot*|debian-buster-desktop-arm64|android10|friendlycore-lite-focal-kernel4-arm64|friendlycore-focal-arm64|friendlywrt* )
        ;;
*)
