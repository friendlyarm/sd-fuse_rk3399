...
function usage() {
       ...
       echo "    examples:"
       echo "        ./mk-emmc-image.sh friendlywrt-kernel4 myimg-emmc.img autostart=yes"
...
case ${TARGET_OS} in
android10|friendlycore-focal-arm64|friendlycore-lite-focal-kernel4-arm64|friendlywrt-kernel4 )
        ;;
*)
