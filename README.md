...
wget https://downloads.friendlyelec.com/os-images/rk3399/images/friendlydesktop-arm64-images.tgz
...
*Note: Here we use friendlydesktop system as an example*  
Clone this repository locally, then download and uncompress the [pre-built images](https://downloads.friendlyelec.com/os-images/rk3399/images), here you need to download the friendlydesktop and eflasher [pre-built images](https://downloads.friendlyelec.com/os-images/rk3399/images):
```
git clone https://github.com/friendlyarm/sd-fuse_rk3399 -b master --single-branch sd-fuse_rk3399-kernel4.4
cd sd-fuse_rk3399-kernel4.4
wget https://downloads.friendlyelec.com/os-images/rk3399/images/friendlydesktop-arm64-images.tgz
...
```
wget https://downloads.friendlyelec.com/rootfs/rk3399/rootfs-friendlydesktop-arm64.tgz
wget https://downloads.friendlyelec.com/rootfs/rk3399/rootfs-friendlydesktop-arm64.tgz.sha256
sha256sum -c rootfs-friendlydesktop-arm64.tgz.sha256
