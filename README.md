...
wget https://downloads.friendlyelec.com/os-images/rk3399/images/friendlycore-focal-arm64-images.tgz
...
*Note: Here we use friendlycore-focal system as an example*  
Clone this repository locally, then download and uncompress the [pre-built images](https://downloads.friendlyelec.com/os-images/rk3399/images), here you need to download the friendlycore-focal and eflasher [pre-built images](https://downloads.friendlyelec.com/os-images/rk3399/images):
```
git clone https://github.com/friendlyarm/sd-fuse_rk3399 -b kernel-4.19 --single-branch sd-fuse_rk3399-kernel4.19
cd sd-fuse_rk3399-kernel4.19
wget https://downloads.friendlyelec.com/os-images/rk3399/images/friendlycore-focal-arm64-images.tgz
...
```
wget https://downloads.friendlyelec.com/rootfs/rk3399/rootfs-friendlycore-focal-arm64.tgz
wget https://downloads.friendlyelec.com/rootfs/rk3399/rootfs-friendlycore-focal-arm64.tgz.sha256
