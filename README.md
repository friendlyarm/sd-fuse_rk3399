...
* kernel source code: In the directory "07_Source codes" of [NetDrive](https://download.friendlyelec.com/rk3399), or download from [Github](https://github.com/friendlyarm/kernel-rockchip), the branch name is nanopi-r2-v6.6.y
...
* pre-built partition image: In the directory "03_Partition image files" of [NetDrive](https://download.friendlyelec.com/rk3399), or download from [server](https://downloads.friendlyelec.com/os-images/rk3399/images)
* compressed root file system tar ball: In the directory "06_File systems" of [NetDrive](https://download.friendlyelec.com/rk3399), or download from [server](https://downloads.friendlyelec.com/rootfs/rk3399)
...
Clone this repository locally, then download and uncompress the [pre-built images](https://downloads.friendlyelec.com/os-images/rk3399/images):
```
...
wget https://downloads.friendlyelec.com/os-images/rk3399/images/openmediavault-arm64-images.tgz
...
```
out/rk3399-sd-openmediavault-6.6-arm64-YYYYMMDD.img
```
...
*Note: Here we use openmediavault system as an example*  
Clone this repository locally, then download and uncompress the [pre-built images](https://downloads.friendlyelec.com/os-images/rk3399/images), here you need to download the openmediavault and eflasher [pre-built images](https://downloads.friendlyelec.com/os-images/rk3399/images):
```
git clone https://github.com/friendlyarm/sd-fuse_rk3399 -b kernel-6.6.y --single-branch sd-fuse_rk3399-kernel6.6
cd sd-fuse_rk3399-kernel6.6
wget https://downloads.friendlyelec.com/os-images/rk3399/images/openmediavault-arm64-images.tgz
tar xvzf openmediavault-arm64-images.tgz
wget https://downloads.friendlyelec.com/os-images/rk3399/images/emmc-flasher-images.tgz
...
```
out/rk3399-eflasher-openmediavault-6.6-arm64-YYYYMMDD.img
```
...
```
wget https://downloads.friendlyelec.com/rootfs/rk3399/rootfs-openmediavault-arm64.tgz
wget https://downloads.friendlyelec.com/rootfs/rk3399/rootfs-openmediavault-arm64.tgz.sha256
sha256sum -c rootfs-openmediavault-arm64.tgz.sha256
