...
克隆本仓库到本地, 然后下载并解压friendlydesktop系统的[分区镜像文件压缩包](https://downloads.friendlyelec.com/os-images/rk3399/images):
```
...
*注: 这里以friendlydesktop系统为例进行说明*  
克隆本仓库到本地, 然后下载并解压[分区镜像文件压缩包](https://downloads.friendlyelec.com/os-images/rk3399/images), 这里需要下载friendlydesktop和eflasher系统的文件:
```
git clone https://github.com/friendlyarm/sd-fuse_rk3399 -b master --single-branch sd-fuse_rk3399-kernel4.4
cd sd-fuse_rk3399-kernel4.4
wget https://downloads.friendlyelec.com/os-images/rk3399/images/friendlydesktop-arm64-images.tgz
